function [solution,model] = maxGrowthOnLS(model)
...
% Lactate
model = changeRxnBounds(model,'EX_cpd00159(e)',-10.118044,'b');
% Sulfate
...
model = changeRxnBounds(model,'rxn00062',5,'b');
...
if solution.f > 0 
[~,bio_idx] = intersect(model.rxns,'bio_DvH_85gam');
